$(function(){
    ...
    //     // event 마우스휠의 정보
    //     // d는 이동 방향
    //     // 마우스휠을 위로 스크롤하면 양수(+1) / 아래로 스크롤하면 음수(-1)
    //     // console.log(d);
    //     if(d>0){ // 휠 위로
    ...
    // $.cookie에 popup 이름에 none값이 있으면 $('#notice_wrap')를 가려라
    ...
    function closePop(){
        if(chk.is(':checked')){
            ...
            // chk 변수(체크박스)가 cheked를 가지고있으면 popup에 none을 3일동안 저장
        }
