...
// Card의 인스턴스인 c1과 c2는 클래스(static) 변수인 width, height를 공유하기 때문에 c1의 width, height를 변경하면 c2의 width, height값도 바뀐것과 같은 결과를 얻는다.
// Card.width, c1.width, c2.width 모두 같은 저장공간을 참조하므로 항상 같은 값이다.