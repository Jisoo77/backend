...
public class AccManager {
    ...
    public boolean bookedAccommodations(String name) {
        for (Accommodation accommodation : accommodations) {
            if(accommodation.getName().equalsIgnoreCase(name) && accommodation.isAvailable()){ // equalsIgnoreCase 소문자로만 비교
    ...
    public void delereAccomodation(String dname) {
    ...
    public void updateAccommodation(String uname) {
        ...
        for(Accommodation a : accommodations){ // 리스트 순회하면서 같은 이름이 있는지
            i++;
