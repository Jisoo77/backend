            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    if(manager.bookedAccommodations(accommodationName)){
                        ...
                        System.out.println("숙소가 예약가능하지 않거나 존재하지 않습니다.");
                    }
                    break;
                ...
                case 4:
                    ...
                    if(newName.equals("")){ // 숙소이름이 입력되어있지 않으면 재입력받기
                        System.out.print("추가하려는 숙소의 이름을 입력하세요\n 숙소이름 >>");
                        newName = sc.nextLine();
                    }
                ...
                case 5:
                    ...
                    manager.delereAccomodation(dname);
                ...
                case 7:
                    ...
                    if(sname.equals("")){
                        System.out.println("조회하려는 숙소의 이름을 입력하세요. \n uname>>");
                        newName = sc.nextLine();
                    }
